...
//Adapted from above to treat parameters and constants only by type
//To be more performant, could be less precise: false positives aren't
//that bad. Just don't return false negatives!
...
{
    class ExpressionHasher : VoidExpressionVisitor
    {
